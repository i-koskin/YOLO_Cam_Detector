## 🚨 Система видеомониторинга с распознаванием объектов и уведомлениями
...
- использовал модель YOLO для детекции объектов;
- использовал FastAPI для управления настройками;
- реализовал функционал для уведомления по email (в заданные часы);
- разработал функционал для сохранения изображений (ROI или полный кадр) при срабатывании;
- реализовал функционал для распознавания номерных знаков;
- реализовал цветовое выделение классов и сортировку по частоте;
- разработал гибкую систему логирования с уровнями, цветным выводом и ротацией логов.
